...
{#if canSwitch && activeClub}
	<div class="relative shrink-0">
		...
		{#if open}
			...
			<div
				class="absolute right-0 top-full z-50 mt-2 w-64 max-w-[calc(100vw-1rem)] overflow-hidden rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-lg"
				role="menu"
			>
