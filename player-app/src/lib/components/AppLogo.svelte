...
<svg width={size} height={size} viewBox="0 0 48 48" class={className} role="img" aria-label={title}>
	<g transform="translate(3, 3) scale(1.005)">
		<path fill={fill} transform="translate(-134.376 -169.268)" d={SHUTTLECOCK_PATH} />
	</g>
</svg>
