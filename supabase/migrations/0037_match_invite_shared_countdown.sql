-- Invite window is fixed (30s from creation). All invited players see the same countdown;
-- if it expires before all four accept, the match is cancelled for everyone.
